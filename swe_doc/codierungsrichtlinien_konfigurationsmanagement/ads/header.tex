...
\lstloadlanguages{PHP,Python,Java,C,C++,bash, HTML}

\listingsettings{}
% Rename Listings
\renewcommand{\listingPhrase}{Quellcode}
\renewcommand{\listListingPhrase}{Programmauszugsverzeichnis}
\renewcommand{\authorListingPhrase}{Quellcode}
