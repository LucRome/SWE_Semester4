...
course_names = ['19IN-Rechnerarchitekturen', '19IN-Compilerbau', '19IN-Web Engineering', '19IN-Betriebssysteme', '19IN-SWE', '19IN-Signale und Systeme', '19IN-Statistik', '19IN-Matlab', '19IN-Wahlfach', '19IN-Elektrotechnik', '19IN-Physik', '19IN-ETST']
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i in COURSE_NUM:
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    'Successfully created testcourse with name {}'.format(c.name)
                )
            )
